...
public class CreateTimetableDocumentPanel extends JPanel {
    private ScrollingTable toCreateTable;
    ...
    public CreateTimetableDocumentPanel(TimetablePanel timetablePanel) {
        ...
        toCreateTable = new ScrollingTable(makeDataFromActivities(prompts, activityNames), headings, widths, numRows, false);

        // Add an on-click listener
        toCreateTable.table.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    int row = toCreateTable.table.getSelectedRow();
    ...
    public void update() {
        ...
        toCreateTable.table.changeData(data);
    }
